/*
  # Create Patreon Data Tables

  1. New Tables
    - `patreon_campaigns`
      - Stores campaign data from connected Patreon pages
      - Links to patreon_pages via page_id
    - `patreon_tiers`
      - Stores reward tier information
      - Links to campaigns via campaign_id
    - `patreon_patrons`
      - Stores patron profile information
    - `patreon_memberships`
      - Stores pledge relationships between patrons and campaigns
      - Links patrons to campaigns with additional pledge data
